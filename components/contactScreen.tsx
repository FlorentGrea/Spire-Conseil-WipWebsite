    ...
    <div className="screen-container" data-screen="contact">
      <div className="screen-content flex-col">
        ...
        <div className="flex flex-col items-center justify-center max-w-sm sm:max-w-lg lg:max-w-xl">
          ...
          <div className="content-box content-box-v2 w-full flex-grow">
            <form onSubmit={handleSubmit} className="space-y-2 lg:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-1.5 lg:gap-4">
                <div>
                  <label className="block text-xs lg:text-xl font-medium text-gray-700 mb-0.5">Nom et prénom *</label>
                  <input
                ...
                <div>
                  <label className="block text-xs lg:text-xl font-medium text-gray-700 mb-0.5">Email *</label>
                  <input
                    className="w-full px-1 sm:px-1.5 md:px-2 lg:px-3 py-0.5 sm:py-1 md:py-1.5 lg:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#012073] focus:border-transparent transition-all duration-200 text-xs lg:text-xl"
                    name="email"
                    type="email"
                ...
                <div>
                  <label className="block text-xs lg:text-xl font-medium text-gray-700 mb-0.5">Téléphone</label>
                  <input
                    className="w-full px-1 sm:px-1.5 md:px-2 lg:px-3 py-0.5 sm:py-1 md:py-1.5 lg:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#012073] focus:border-transparent transition-all duration-200 text-xs lg:text-xl"
                    name="phone"
                    value={form.phone}
              ...
              <div>
                <label className="block text-xs lg:text-xl font-medium text-gray-700 mb-0.5">Message</label>
                <textarea
              ...
              <div className="flex flex-row items-center justify-start">
                <input 
                  ...
                  onChange={handleChange} 
                  className="mr-2 sm:mr-3 w-3 h-3 sm:w-4 sm:h-4 text-[#012073] border-gray-300 rounded focus:ring-[#012073]"
                />
